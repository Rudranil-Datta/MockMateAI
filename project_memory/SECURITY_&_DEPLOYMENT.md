...
Startup must validate the presence and format of required configuration. In production, the API should refuse to start with a missing database URI, selected AI-provider key, authentication secret, or trusted frontend origin.
